...
import { artifactAttributeTypeSchema } from "@/lib/artifacts"
import { Artifact, ArtifactAttributeDescriptions } from "@/types/artifacts"
import * as Attribute from "@/components/attribute"
import CollapsibleCard from "@/components/collapsible-card"

type Key = keyof typeof artifactAttributeTypeSchema
...
export default function AllAttributes({
  ...
  const keys = (Object.keys(artifactAttributeTypeSchema) as Key[]).sort(
  ...
  const row = (k: Key) => (
    <Attribute.Field
      ...
      value={
        <Attribute.Value
          type={artifactAttributeTypeSchema[k]}
          value={artifact.attributes[k] as string | number | boolean | null}
          tooltip={
            (ArtifactAttributeDescriptions as Record<Key, string | undefined>)[
              k
            ]
          }
        />
