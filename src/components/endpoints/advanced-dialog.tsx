...
import { useGetEndpoint } from "@/queries/endpoints"
...
export default function AdvancedDialog({
  ...
  const hasError = endpointError && !endpointFetching
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          {!endpoint || endpointLoading ? (
            ...
            >
              ...
              >
                <ScrollArea className="min-h-0 w-full min-w-0">
                  <div className="flex min-w-0 flex-col gap-2 p-2">
                    <Endpoints.AllAttributes endpoint={endpoint} />
                  </div>
                </ScrollArea>
              </TabsContent>
              ...
              >
                <InspectResource resource={endpoint} />
              </TabsContent>
            </Tabs>
          )}
        </div>
