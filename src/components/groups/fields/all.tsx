...
import { GroupFormFieldDescriptions } from "@/types/groups"
...
function CreateLayout({
  ...
  const form = useFormContext<Forms.Groups.CreateValues>()
              ...
              render={({ field }) => (
                <FormItem>
                  <Field.Header
                    label="Max Users"
                    variant="stacking"
                    tooltip={GroupFormFieldDescriptions.maxUsers}
                  >
                    <FormControl>
                      <Input
                        {...field}
              ...
              render={({ field }) => (
                <FormItem>
                  <Field.Header
                    label="Max Licenses"
                    variant="stacking"
                    tooltip={GroupFormFieldDescriptions.maxLicenses}
                  >
                    <FormControl>
                      <Input
                        {...field}
              ...
              render={({ field }) => (
                <FormItem>
                  <Field.Header
                    label="Max Machines"
                    variant="stacking"
                    tooltip={GroupFormFieldDescriptions.maxMachines}
                  >
                    <FormControl>
                      <Input
                        {...field}
              ...
              render={() => (
                <FormItem>
                  <Field.Header
                    ...
                    variant="stacking"
                    optional
                    tooltip={GroupFormFieldDescriptions.metadata}
                  >
                    <FormControl>
                      <KeyValueInput<Forms.Groups.CreateValues> name="metadata" />
                    </FormControl>
                  </Field.Header>
                  <FormMessage />
                </FormItem>
...
function EditLayout({
  ...
  const form = useFormContext<Forms.Groups.UpdateValues>()
          ...
          render={({ field }) => (
            <FormItem>
              <Field.Header
                label="Group name"
                variant="stacking"
                tooltip={GroupFormFieldDescriptions.name}
              >
                <FormControl>
                  <Input
                    {...field}
      ...
      <FormField
        ...
        render={() => (
          <FormItem>
            ...
            >
              <FormControl>
                <KeyValueInput<Forms.Groups.UpdateValues> name="metadata" />
              </FormControl>
            </Field.Header>
            <FormMessage />
          </FormItem>
