...
export default function AdvancedDialog({
  ...
  const hasError = licenseError && !licenseFetching
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          {!license || licenseLoading ? (
            ...
            >
              ...
              >
                <ScrollArea className="min-h-0 w-full min-w-0">
                  <div className="flex min-w-0 flex-col gap-2 p-2">
                    <Licenses.AllAttributes license={license} />

                    <CollapsibleCard title="Metadata" contentClass="p-0">
                      <Metadata resource={license} className="p-2" />
                    </CollapsibleCard>
                  </div>
                </ScrollArea>
              </TabsContent>
              ...
              >
                <InspectResource resource={license} />
              </TabsContent>
            </Tabs>
          )}
        </div>
