...
import { useListLicenseEntitlements } from "@/queries/licenses"
...
interface LicenseEntitlementsDialogProps {
  id: string
  open: boolean
...
export default function LicenseEntitlementsDialog({
  id,
  open,
  onOpenChange,
  title = "License entitlements",
}: LicenseEntitlementsDialogProps) {
