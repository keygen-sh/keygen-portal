...
export default function AdvancedDialog({
  ...
  const hasError = processError && !processFetching
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          {!process || processLoading ? (
            ...
            >
              ...
              >
                <ScrollArea className="min-h-0 w-full min-w-0">
                  <div className="flex min-w-0 flex-col gap-2 p-2">
                    <Processes.AllAttributes process={process} />

                    <CollapsibleCard title="Metadata" contentClass="p-0">
                      <Metadata resource={process} className="p-2" />
                    </CollapsibleCard>
                  </div>
                </ScrollArea>
              </TabsContent>
              ...
              >
                <InspectResource resource={process} />
              </TabsContent>
            </Tabs>
          )}
        </div>
