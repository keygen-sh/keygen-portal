...
export default function AdvancedDialog({
  ...
  const hasError = releaseError && !releaseFetching
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          {!release || releaseLoading ? (
            ...
            >
              ...
              >
                <ScrollArea className="min-h-0 w-full min-w-0">
                  <div className="flex min-w-0 flex-col gap-2 p-2">
                    <Releases.AllAttributes release={release} />

                    <CollapsibleCard title="Metadata" contentClass="p-0">
                      <Metadata resource={release} className="p-2" />
                    </CollapsibleCard>
                  </div>
                </ScrollArea>
              </TabsContent>
              ...
              >
                <InspectResource resource={release} />
              </TabsContent>
            </Tabs>
          )}
        </div>
