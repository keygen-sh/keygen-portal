...
type Descriptions = typeof WebhookEndpointFormFieldDescriptions

interface WebhookEndpointsFormFieldsProps {
  include?: Schemas.WebhookEndpoints.FieldNames[]
  exclude?: Schemas.WebhookEndpoints.FieldNames[]
  autoFocus?: Schemas.WebhookEndpoints.FieldNames
  titleVariant?: boolean
  fieldVariant?: FieldVariant
  schema?: "create" | "edit"
}

const INCLUDE_DEFAULT_FIELDS: Schemas.WebhookEndpoints.FieldNames[] = [
  "url",
  "subscriptions",
  "signatureAlgorithm",
  "apiVersion",
...
export default function WebhookEndpointsFormFields({
  include,
  exclude = [],
  autoFocus,
  titleVariant,
