...
export function partitionSettledMutations<T>(results: PromiseSettledResult<T>[]): MutationPartition<T> {
...
export async function settleMutations<T>(mutations: Promise<T>[]): Promise<MutationPartition<T>> {
